...
{
    botAI->Reset();
    static const std::array<char const*, 6> spells =
    {
        "divine protection",
        "fade",
        "feign death",
...
{
    Position const* movePosition = nullptr;
...
bool KaelthasSunstriderManageAdvisorDpsTimerAction::Execute(Event /*event*/)
{
    ...
    static const std::array<char const*, 3> advisorNames =
    {
...
bool KaelthasSunstriderBreakMindControlAction::Execute(Event /*event*/)
{
    ...
    {
        static const std::array<char const*, 4> spells =
        {
            "hamstring",
            "wing clip",
            "shiv",
...
bool KaelthasSunstriderBreakThroughShockBarrierAction::Execute(Event /*event*/)
{
    ...
    {
        static const std::array<char const*, 8> spells =
        {
            "bash",
            "counterspell",
            "kick",
